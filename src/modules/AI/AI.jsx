...
export default function AI() {
  ...
  const handleSearch = () => {
    ...
    // kichik harflarga o'girib qiyoslash uchun:
  ...
  return (
    <div>
      ...
      <div className="ai-helper" style={{ padding: '20px', maxWidth: '700px', margin: '0 auto', marginTop: '80px' }}>
        <h1>🤖 AI помощник</h1>
        ...
        <div className="search" style={{ marginBottom: '20px' }}>
          ...
          />
          <button onClick={handleSearch} style={{ padding: '8px 16px' }}>Найти</button>
        </div>
        ...
        {searched && (
          <div className="suggestions">
            {suggestions.length === 0 ? (
              ...
              <>
                <h3>Результаты по запросу: <em>"{symptom}"</em></h3>
                  ...
                  {suggestions.map((med, index) => (
                    ...
                    >
                      ...
                      <div>
                        <h4>{med.name}</h4>
                        <p>{med.description}</p>
                        <p><strong>{med.price} сом</strong></p>
                      </div>
                    </div>
                  ))}
                </div>
