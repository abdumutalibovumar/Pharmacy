...
function Dashboard() {
  ...
  return (
    <>
    <Header title={'Приборная панель'}/>
      <div className="dashboard">
        <div className="container">
          <div className="stats-cards">
            {[
              { title: "Доход за 1 день", value: "12,000 KGS", delay: 100 },
              { title: "Доход за 1 неделю", value: "80,000 KGS", delay: 200 },
              { title: "Доход за 1 месяц", value: "350,000 KGS", delay: 300 },
              { title: "Доход за 1 год", value: "4,200,000 KGS", delay: 400 },
            ].map((item, index) => (
              <div
                key={index}
                data-aos="slide-up"
          ...
          <div className="medicine-stats">
            <h2 data-aos="fade-left" data-aos-delay="600">
              Статистика лекарств
            </h2>
            <div className="stats-cards">
              {[
